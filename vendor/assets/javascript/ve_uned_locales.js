VE_UNED_Locales = {
	"en": {
		...
		"i.About3"					: "visit our YouTube Channel",
		"i.About4"					: "Developed by",
		"i.VESurvey1"				: "Help us to improve ViSH Editor",
		"i.VESurvey2"				: "Please fill",
		"i.VESurvey3"				: "this survey",
		"i.VESurvey4"				: "Thank you for your collaboration",
		// UI
		"i.accept"					: "accept",
		"i.add"						: "add",
		"i.Add"						: "Add",
		"i.Addanavatar"				: "Add an avatar *",
		"i.AddanavatarHover"		: "Click to add an avatar. You should select an avatar to identify your presentation",
		"i.addatitle"				: "add a title",
		"i.AddContent"				: "Add Content",
		"i.addembeddedobject"		: "add embedded object",
		"i.AddePackage"				: "Add an e-Learning package from a ZIP file. Supported formats: SCORM and custom HTML5 Web Applications.",
		...
		"i.AgeRange"				: "Age Range",
		"i.allowUsersTo"			: "Allow other users to:",
		"i.AllowClone"				: "Clone",
		"i.allowComment"			: "Comment",
		"i.allowDownload"			: "Download",
		"i.Animations"				: "Animations",
		"i.areyousureNotification"	: "are you sure?",
		"i.Art"						: "Art",
		"i.Astronomy"				: "Astronomy",
		"i.Attatchment"				: "Attatchment",
		"i.AudienceResponseSystem"	: "Audience Response System",
		"i.Author"					: "Author",
		...
		"i.EducationalObjectivesPlaceholder"    : "Please describe the educational objectives you aim to fulfil by using this presentation...",
		"i.Electronics"				: "Electronics",
		"i.Elements"				: "Elements",
		"i.embedwebsite"			: "embed website",
		"i.embedWebSnapshot"		: "embed Web Snapshot",
		"i.Enable"					: "Enable",
		"i.enableRTE"				: "Enable object tracking when it is exported to SCORM",
		"i.EnrichedVideo"			: "Enriched Video",
		"i.EnvironmentalEducation"	: "Environmental Education",
		"i.ePackage"				: "e-Learning Package",
		"i.ePackageError1"			: "An error ocurred when uploading the e&#8209;Learning package.",
		"i.errorFlickrConnection"	: "Error connecting to Flickr",
		"i.errorXWikiConnection"	: "Error connecting to XWiki",
		"i.errorEuropeanaConnection"	: "Error connecting to Europeana",
		"i.errorLREConnection"		: "Error connecting to the LRE repository",
		"i.errorViSHConnection"		: "Error connecting to ViSH-UNED server",
		"i.errorYoutubeConnection"	: "Error connecting to YouTube",
		"i.errorSoundCloudConnection" : "Error connecting to SoundCloud",
		"i.Ethics"					: "Ethics",
		"i.Evaluate"				: "Evaluate",
		"i.evaluateTitle"			: "Want to contribute evaluating the presentation?",
		...
		"i.exitConfirmationMenu"	: "The presentation has been modified. If you close without saving you will lose all changes. What would you like to do?",
		...
		"i.exportQuizToQTIerrorNotification"	: "An error has ocurred. Is not possible to export the quiz to the IMS QTI 2.1 format.",
		"i.exportQuizToMoodleXMLerrorNotification"	: "An error has ocurred. Is not possible to export the quiz to Moodle XML format.",
		"i.ExportToIMSQTI"			: "Export to IMS QTI 2.1",
		"i.ExportToMoodleXML"		: "Export to Moodle XML",
		"i.exviews"					: "views",
		"i.File"					: "File",
		...
		"i.Images"					: "Images",
		"i.Import"					: "Import",
		"i.ImportFromEFile"			: "Import resources from external files:",
		"i.ImportFromEFileVEJSON"	: "ViSH Editor Presentations and Slides from JSON files",
		"i.ImportFromEFileIMSQTI"	: "Quizzes from IMS QTI 2.1 compliant XML files",
		"i.ImportFromEFileMoodleXML"	: "Quizzes from MoodleXML compliant XML files",
		"i.Insert"					: "Insert",
		"i.Inside"					: "Inside",
		...
		"i.Law"						: "Law",
		"i.License"					: "License",
		"i.License_public"			: "Public Domain",
		"i.License_cc-by"			: "Creative Commons Attribution",
		"i.License_cc-by-sa"		: "Creative Commons Attribution-ShareAlike",
		"i.License_cc-by-nd"		: "Creative Commons Attribution-NoDerivs",
		"i.License_cc-by-nc"		: "Creative Commons Attribution-NonCommercial",
		"i.License_cc-by-nc-sa"		: "Creative Commons Attribution-NonCommercial-ShareAlike",
		"i.License_cc-by-nc-nd"		: "Creative Commons Attribution-NonCommercial-NoDerivs",
		"i.License_private"			: "None (All rights reserved)",
		...
		"i.MandatoryFieldsNotification"	: "You need to write a title for the presentation and select an avatar before publish the presentation",
		"i.math" 					: "math",
		...
		"i.NAttempts"				: "Number of Attempts",
		"i.next"					: "next",
		"i.Next"					: "Next",
		"i.no"						: "no",
		...
		"i.NoSupportedFileError"	: "The file cannot be imported. The format is not supported.",
		"i.Object"					: "Object",
		"i.Objects"					: "Objects",
		"i.Ok"						: "Ok",
		"i.OK"						: "OK",
		...
		"i.Options"					: "Options",
		"i.or" 						: "or",
		"i.OSettingsUnload"			: "Unload the object when the slide disappears",
		"i.Other"					: "Other",
		"i.Others"					: "Others",
		"i.Package"					: "Package",
		...
		"i.MetadataAspects"		: "Metadata",
		"i.pEducation"				: "Primary Education",
		"i.Philosophy"				: "Philosophy",
		"i.PhysicalEducation"		: "Physical Education",
		"i.Physics"					: "Physics",
		"i.Politics"				: "Politics",
		"i.Preschool"				: "Preschool Education",
		"i.Presentation"			: "Presentation",
		"i.PresentationsRepository" : "Search on the repository the presentation you would like to import",
		"i.presDescriptionPlaceHolder"  : "Please describe in a few words what your presentation is about",
		"i.presTitle"				: "Presentation title",
		"i.Preview"					: "Preview",
		"i.Psychology"				: "Psychology",
		"i.PTraining"				: "Professional Training",
		...
		"i.Publishing"				: "Publishing",
		"i.Publish_confirmation"	: "You are going to save and publish this presentation on the ViSH-UNED Platform. After this, the presentation will be public and anyone will be able to access it. What would you like to do?",
		"i.Quiz"					: "Quiz",
		...
		"i.QuizErrorQuestionsUnsupported" : "Some items are not supported by ViSH Editor and couldn't be converted",
		"i.QuizLaunch"				: "Launch",
		...
		"i.QuizSettingsToolbar"		: "Quiz Settings",
		"i.QuizStop"				: "Stop",
		"i.QuizSubmittedAlert"		: "Your answer has been submitted",
		"i.Quizzes"					: "Quizzes",
		"i.QuizzesWriteOptions"		: "Write options here",
		"i.QuizzesWriteOptionsOpen"	: "Write the answer here",
		"i.QuizzesWriteOptionsSorting"	: "Write the first item of the sequence here",
		"i.readJSONfileError"		: "Error reading JSON file",
		"i.recommendationsTitle"	: "Recommended presentations:",
		"i.Religion"				: "Religion",
		"i.Remove"					: "Remove",
		"i.Resize+"					: "Resize+",
		"i.Resize-"					: "Resize-",
		...
		"i.Seconds"					: "Seconds",
		"i.sEducation"				: "Secondary Education",
		...
		"i.ShuffleChoices"			: "Shuffle choices",
		"i.Slide"					: "Slide",
		"i.Slides"					: "Slides",
		...
		"i.Unpublishing"			: "Unpublishing",
		"i.Unpublish_confirmation"	: "You are going to unpublish this presentation from the ViSH-UNED Platform. After this, the presentation will be private and only you will be able to access it. What would you like to do?",
		"i.Unknown"					: "Unknown",
		...
		"i.upload"					: "upload",
		"i.Upload"					: "Upload",
		"i.uploadErrorWrongServer"	: "Server returned an error status",
		"i.uploadErrorTooBig"		: "Current file is bigger than 8MB, try again",
		"i.uploadErrorCantReach"	: "File request can't reach server",
		"i.uploadHasToSaveFirst"	: "You must save the presentation before uploading any file",
		"i.url"						: "url",
		"i.Url"						: "Url",
		"i.Version"					: "Version",
		"i.Vertical"				: "Vertical",
		...
		"i.Video"					: "Video",
		"i.Videos"					: "videos",
		"i.VirtualTour"				: "VirtualTour",
		"i.wappSettings"			: "Web Application Settings",
		"i.wappSettingsEnableAPI"	: "Enable Web Application API",
		"i.wappSettingsSecores"		: "This app send scores",
		"i.yes"						: "yes",
		"i.Yes"						: "Yes",
		...
		"i.tooltip.UploadAttachment" : "If this button is disabled, you need to save your presentation first",
	...
	"es": {
		...
		"i.walkWelcome1_2"			: "ViSH Editor es una aplicación web innovadora que permite crear increibles presentaciones web y recursos educativos novedosos como presentaciones interactivas.",
		...
		"i.walkWelcome7_1"			: "Este botón te permite publicar tu presentación en la plataforma ViSH-UNED. Si no has terminado tu presentación, puedes guardarla como borrador para mantenerla privada y terminarla después.",
		...
		"i.walkSettings1_2"			: "Aquí puedes especificar información acerca de tu presentación.",
		"i.walkSettings1_3"			: "El título y el avatar (una imagen que identifica tu presentación en la plataforma ViSH-UNED) son campos obligatorios, de modo que debes rellenarlos antes de publicar la presentación.",
		"i.walkSettings1_4"			: "A la izquierda, puedes ver una previsualización de como tu presentación será mostrada en la plataforma ViSH-UNED.",
		"i.walkSettings2_1"			: "Escribe un título (Obligatorio)",
		"i.walkSettings2_2"			: "Escribe el título de tu presentación en esta caja de texto. Este titulo es importante porque es el que se mostrará en la plataforma ViSH-UNED y el que verán el resto de usuarios.",
		"i.walkSettings3_1"			: "Añade un avatar para tu presentación (Obligatorio)",
		"i.walkSettings3_2"			: "Pulsa sobre este botón para elegir una imagen que represente a tu presentación. Esta imagen será el avatar de tu presentación y es importante porque será mostrada en la plataforma ViSH-UNED, permitiendo a los usuarios identificar la presentación.",
		"i.walkSettings4_1"			: "Añade una licencia para esta presentación (Obligatorio)",
		"i.walkSettings4_2"			: "Ya que eres el autor de esta presentación, necesitas que tenga una licencia. Para ello puedes incluir una de las siguientes licencias de Creative Commons desde el menú desplegable. Esta es la página de licencias Creative Commons (https://creativecommons.org/licenses/) donde te explican las diferentes licencias en profundidad.",
		"i.walkSettings4_3"			: "Recuerda que solamente puedes cambiar la licencia antes de publicar la presentación. Si ya la has publicado, el menú desplegable permanecerá desactivado y no podrás cambiarla.", 
		"i.walkSettings5_1"			: "Escribe una descripción",
		"i.walkSettings5_2"			: "Aqui puedes explicar en detalle sobre qué trata la presentación.",
		"i.walkSettings5_3"			: "Esta descripción será mostrada en la plataforma ViSH-UNED en la página de esta presentación. Por lo tanto, todos los usuarios que accedan a esta presentación podrán leerla.",
		"i.walkSettings6_1"			: "Selecciona un tema para tu presentación",
		"i.walkSettings6_2"			: "Un tema define la apariencia visual de la presentación. ViSH Editor ofrece diferentes temas entre los cuales puedes elegir.",
		"i.walkSettings6_3"			: "Para seleccionar un tema, simplemente pulsa sobre el icono que quieras de esta galería.",
		"i.walkSettings6_4"			: "Recuerda que puedes cambiar el tema de la presentación en cualquier momento accediendo a esta pantalla o pulsando sobre el botón 'Estilo' en la barra de herramientas.",
		"i.walkSettings7_1"			: "Añade etiquetas a tu presentación",
		"i.walkSettings7_2"			: "Aqui puedes añadir etiquetas (o palabras clave) a tu presentación.",
		"i.walkSettings7_3"			: "Estas palabras clave son muy útiles para categorizar la presentación. Además, también se emplean como términos de búsqueda en la plataforma ViSH-UNED (asi como en otros repositorios), y por lo tanto añadir palabras clave a una presentación facilita su búsqueda y acceso.",
		"i.walkSettings7_4"			: "Ejemplos de etiquetas",
		"i.walkSettings8_1"			: "Fichero Adjunto",
		"i.walkSettings8_2"			: "Puedes añadir materiales complementarios para tu presentación mediante un fichero adjunto.",
		"i.walkSettings8_3"			: "Para subir un fichero adjunto debes haber guardado previamente la presentación. Una vez subido el fichero adjunto, los usuarios podrán descargarlo desde la página de la presentación en la plataforma ViSH-UNED.",
		"i.walkSettings9_1"			: "Opciones avanzadas",
		"i.walkSettings9_2"			: "Al pulsar sobre este botón aparecerá la pantalla de Opciones Avanzadas.",
		"i.walkSettings9_3"			: "En esta pantalla podrás especificar más información pedagógica, permisos y otros aspectos acerca de tu presentación.",
		"i.walkSettings9_4"			: "Los detalles sobre la información que puede ser especificada se describen en la ayuda contextual de las pantallas de opciones avanzadas.",
		"i.walkSettings10_1"		: "Empezar a utilizar ViSH Editor",
		"i.walkSettings10_2"		: "Una vez que hayas rellenado la información de tu presentación, por lo menos el título y el avatar, puedes empezar a crear tu presentación con ViSH Editor pulsando sobre el botón 'Continuar'.",
		"i.walkSettings10_3"		: "Si no deseas rellenar la información en este momento, también puedes empezar a usar ViSH Editor pulsando sobre el botón 'Rellenar después', en este caso recuerda que deberás volver a la pantalla de Ajustes y completar todos los campos obligatorios antes de publicar la presentación.",
		
		"i.walkMetadata1_1" 		: "Bienvenido a la pantalla de Metadatos",
		"i.walkMetadata1_2_1" 		: "En esta pantalla puedes especificar más información pedagógica acerca de tu presentación. Estos metadatos están basados y son conformes al estándar LOM (Learning Object Metadata). La última especificación de este estándar, en la cual se explica de una manera detallada todos los campos de esta pantalla, se puede encontrar",
		"i.walkMetadata1_2_2" 		: "aquí",
		"i.walkMetadata1_3" 		: "A continuación se ofrece una breve explicación de cada uno de los campos que se pueden especificar en esta pantalla.",
		"i.walkMetadata1_4" 		: "El idioma de tu presentación.",
		"i.walkMetadata1_5" 		: "El entorno principal dentro del cual está destinado a tener lugar el aprendizaje y uso de este objeto de aprendizaje (es decir, la presentación).",
		"i.walkMetadata1_6" 		: "Edad del usuario típico esperado.",
		"i.walkMetadata1_7" 		: "Como de complicado es trabajar con o a través de este objeto de aprendizaje.",
		"i.walkMetadata1_8" 		: "Tiempo aproximado o típico que se necesita para trabajar con este objeto de aprendizaje.",
		"i.walkMetadata1_9" 		: "El tema (o temas) de esta presentación.",
		...
		"i.walkPublication1_2"		: "En esta pantalla podrás cambiar los permisos que tendrán el resto de usuarios de la plataforma ViSH-UNED sobre tu presentación una vez publicada. Podrás cambiar esta configuración en cualquier momento.",
		"i.walkPublication1_3"		: "permite activar o desactivar los comentarios de la presentación.",
		"i.walkPublication1_4"		: "permite a otros usuarios descargar la presentación en cualquier formato.",
		"i.walkPublication1_5"		: "permite a otros usuarios obtener una copia de la presentación en su propia cuenta manteniendo la cadena de autoría e incluyendo una referencia al autor (o autores) original.",
		
		"i.walkRTE1_1"				: "Bienvenido a la pantalla de opciones del RTE",
		"i.walkRTE1_2"				: "En esta pantalla podrás especificar las opciones de integración e interacción del objeto de aprendizaje (es decir, la presentación) con el RTE (Run-Time Environment) o entorno de ejecución.",
		...
		"i.walkImagesMain_ViSH"		: "busca imágenes en el repositorio del ViSH-UNED",
		"i.walkImagesMain_Flickr"	: "busca imágenes en Flickr",
		"i.walkImagesMain_Europeana"	: "busca imágenes en Europeana",
		...
		"i.walkImagesUpload2_2"		: "Aquí puedes añadir una imagen propia de tu dispositivo. Para ello, en primer lugar debes seleccionar la imagen que quieras empleando el selector de ficheros. Opcionalmente, puedes escribir etiquetas para clasificar la imagen seleccionada. Después debes de hacer click en el botón \"subir\" para subir la imagen a la plataforma ViSH-UNED. Cuando la imagen se haya subido, se mostrará una vista previa de la misma en la parte inferior. Finalmente, para añadir la imagen a la diapositiva debes de pulsar sobre el botón \"Añadir Contenido\".",
		"i.walkImagesViSH1_1"		: "Ahora te encuentras en la pestaña de ViSH-UNED, haz click en \"Siguiente\" para continuar.",
		"i.walkImagesViSH2_1"		: "Buscar imágenes en el repositorio del ViSH-UNED",
		"i.walkImagesViSH2_2"		: "Esta pantalla te permite buscar imágenes en el repositorio del ViSH-UNED (http://vish.ieec.uned.es).",
		...
		"i.walkImagesEuropeana1_1"		: "Ahora te encuentras en la pestaña de Europeana, haz click en \"Siguiente\" para continuar.",
		...
		"i.walkObjectsMain_ViSH"	: "busca objetos en el repositorio ViSH-UNED",
		...
		"i.walkVideosMain_ViSH"		: "busca videos HTML5 en el repositorio ViSH-UNED",
		...
		"i.walkVideosUpload_3"		: "y sube tu archivo de vídeo al repositorio ViSH-UNED. Varios formatos de vídeo (mp4, flv, mpg, avi, ...) están soportados. Cuando termines de subir el vídeo a ViSH-UNED este será convertido a todos los formatos de video compatibles con HTML5 (mp4, webm y ogg). Tenga en cuenta que este proceso puede tardar varios minutos o incluso horas, dependiendo del tamaño del vídeo. Esta es una buena forma de insertar los videos porque de este modo estarán disponibles en varios formatos y funcionarán en todos los navegadores web que soporten HTML5. Una vez que el proceso haya finalizado, tienes dos formas de añadir un vídeo",
		"i.walkVideosUpload_4"		: "Buscar tu vídeo en el repositorio ViSH-UNED desde el ViSH Editor a través de la pestaña 'ViSH-UNED'. En este caso tendrás que esperar varias horas (como máximo) hasta que el motor de búsqueda de ViSH-UNED haya indexado el nuevo vídeo.",
		"i.walkVideosUpload_5"		: "Otra forma es acceder a la página del vídeo en ViSH-UNED y seleccionar la tab 'insertar'. Después hay que copiar el código de inserción proporcionado y pegarlo en la caja de texto de la tab 'url' en el ViSH Editor. De esta forma, el video será insertado de forma inmediata.",
		...
		"i.walkLive_2"				: "ViSH-UNED ofrece recursos especiales como webcams en vivo, microscopios o laboratorios virtuales provistos por determinadas ciberinfraestructuras.",
		"i.walkLive_3"				: "En esta pantalla podrás buscar recursos de este tipo en el repositorio ViSH-UNED.",
		...
		"i.walkInsertingViSHPres_1"	: "Añadiendo Diapositivas de Presentaciones",
		"i.walkInsertingViSHPres_2"	: "Aquí puedes buscar presentaciones en la plataforma ViSH-UNED para añadirlas (o añadir determinadas diapositivas de ellas) a tu presentación.",
		"i.walkInsertingViSHPres_3"	: "Haz click en cualquiera de las presentaciones para seleccionarla. Después, se mostrará un nuevo botón 'Vista Previa'. Cuando pulses este botón, aparecerá una nueva ventana para que elijas las diapositivas que quieres insertar en tu presentación.",
		"i.walkPresSearch2"			: "y pulsa la tecla 'intro' para comenzar la búsqueda. Cuando termine la búsqueda, las presentaciones encontradas serán mostradas en esta pantalla.",
		...
		"i.walkEVideo_4"			: "Puedes usar videos de YouTube y HTML5 (formatos mp4, webm y ogg). Además, puedes subir tu propio vídeo al repositorio ViSH-UNED para que sea convertido en formatos compatibles con HTML5 asegurando una compatibilidad completa en todos los dispositivos",
		...
		"i.walkQuizzes_3"			: "Para lanzar un 'Cuestionario en Vivo' tienes que acceder a una presentación y hacer click en el botón 'Lanzar' situado en la parte inferior del cuestionario que quieras usar. Ten en cuenta que el botón 'Lanzar' no se muestra cuando previsualizas una presentación con el editor. Cuando lanzas un cuestionario en vivo, se crea una 'sesión de cuestionario' en la plataforma ViSH-UNED, la cual almacenará todos los resultados y estadísticas del cuestionario. Una vez que una 'sesión de cuestionario' haya sido creada, podrás acceder a ella (y por tanto ver los resultados y estadísticas) en cualquier momento en la plataforma ViSH-UNED.",
		...
		"i.walkQuizzes_9"			: "Si quieres 'cerrar' el cuestionario en vivo debes hacer click en el botón 'Detener' situado en la parte inferior derecha. Después de cerrar un cuestionario, no se admitirán ni guardarán más respuestas. También puedes cerrar un cuestionario en cualquier momento desde la plataforma ViSH-UNED. Cuando cierras un cuestionario en vivo, puedes, opcionalmente, especificar un nombre para facilitar su búsqueda posterior en ViSH-UNED.",
		...
		"i.AddanavatarHover"		: "Haz clic para añadir un avatar. Debes seleccionar un avatar para identificar tu presentación",
		...
		"i.advancedSettings"		: "Avanzado",
		"i.AgeRange"				: "Rango de edad",
		"i.allowUsersTo"			: "Permitir a otros usuarios:",
		"i.allowClone"				: "Clonar",
		"i.allowComment"			: "Comentar",
		"i.allowDownload"			: "Descargar",
		"i.Animations"				: "Animaciones",
		"i.areyousureNotification"	: "¿estás seguro?",
		"i.Art"						: "Arte",
		"i.Astronomy"				: "Astronomía",
		"i.Attatchment"				: "Fichero Adjunto",
		"i.AudienceResponseSystem"	: "Sistema de Respuesta de Audiencia",
		"i.Author"					: "Autor",
		"i.Background"				: "Fondo",
		"i.biology" 				: "biología",
		"i.Biology"					: "Biología",
		...
		"i.EducationalObjectivesPlaceholder"    : "Describa los objetivos educativos que pretende cumplir con esta presentación...",
		"i.Electronics"				: "Electrónica",
		"i.Elements"				: "Elementos",
		"i.embedwebsite"			: "embeber web",
		"i.embedWebSnapshot"		: "embeber Web Snapshot",
		"i.Enable"					: "Habilitar",
		"i.enableRTE"				: "Habilitar seguimiento del objeto cuando se exporta a SCORM",
		...
		"i.errorXWikiConnection"	: "Error conectando con XWiki",
		"i.errorEuropeanaConnection"	: "Error conectando con Europeana",
		"i.errorLREConnection"		: "Error al conectarse con el repositorio del LRE",
		"i.errorViSHConnection"		: "Error al conectarse con el servidor de ViSH-UNED",
		"i.errorYoutubeConnection"	: "Error conectando con YouTube",
		"i.errorSoundCloudConnection" : "Error conectando con SoundCloud",
		"i.Ethics"					: "Ética",
		"i.Evaluate"				: "Evaluar",
		"i.evaluateTitle"			: "¿Quieres contribuir evaluando esta presentación?",
		...
		"i.exitConfirmationMenu"	: "La presentación se ha modificado. Si la cierra sin guardar perderá todos los cambios. ¿Qué desea hacer?",
		...
		"i.exportQuizToQTIerrorNotification"	: "Ha ocurrido un error. No ha sido posible exportar el cuestionario al formato IMS QTI 2.1.",
		"i.exportQuizToMoodleXMLerrorNotification"	: "Ha ocurrido un error. No ha sido posible exportar el cuestionario al formato Moodle XML.",
		"i.ExportToIMSQTI"			: "Exportar a IMS QTI 2.1",
		"i.ExportToMoodleXML"		: "Exportar a Moodle XML",
		"i.exviews"					: "visitas",
		"i.File"					: "Archivo",
		...
		"i.ImportFromEFileMoodleXML"	: "Cuestionarios (Quizzes) de archivos XML compatibles con MoodleXML",
		"i.Insert"					: "Insertar",
		"i.Inside"					: "Dentro",
		...
		"i.Law"						: "Derecho",
		"i.License"					: "Licencia",
		"i.License_public"			: "Dominio Público",
		"i.License_cc-by"			: "Creative Commons Reconocimiento",
		"i.License_cc-by-sa"		: "Creative Commons Reconocimiento-CompartirIgual",
		"i.License_cc-by-nd"		: "Creative Commons Reconocimiento-SinObraDerivada",
		"i.License_cc-by-nc"		: "Creative Commons Reconocimiento-NoComercial",
		"i.License_cc-by-nc-sa"		: "Creative Commons Reconocimiento-NoComercial-CompartirIgual",
		"i.License_cc-by-nc-nd"		: "Creative Commons Reconocimiento-NoComercial-SinObraDerivada",
		"i.License_private"			: "Ninguna (Todos los derechos reservados)",
		...
		"i.MandatoryFieldsNotification"	: "Tienes que escribir un título y escoger un avatar para la presentación antes de publicarla.",
		"i.math" 					: "matemáticas",
		...
		"i.NAttempts"				: "Número de intentos",
		"i.next"					: "siguiente",
		"i.Next"					: "Siguiente",
		"i.no"						: "no",
		...
		"i.NoSupportedFileError"	: "El archivo no puede ser importado. El formato no está soportado.",
		"i.Object"					: "Objeto",
		"i.Objects"					: "Objetos",
		"i.Ok"						: "Ok",
		"i.OK"						: "OK",
		"i.Opacity"					: "Opacidad",
		"i.Options"					: "Opciones",
		"i.OSettingsUnload"			: "Desactivar el objeto cuando la diapositiva desaparezca",
		"i.or" 						: "o",
		"i.Other"					: "Otro",
		"i.Others"					: "Otros",
		"i.Package"					: "Paquete",
		...
		"i.PresentationsRepository" : "Busque en el repositorio la presentación que desea importar",
		"i.presDescriptionPlaceHolder"  : "Describa brevemente sobre qué trata la presentación",
		"i.presTitle"				: "Título de la presentación",
		...
		"i.Publishing"				: "Publicando",
		"i.Publish_confirmation"	: "Vas a guardar y publicar esta presentación en la plataforma ViSH-UNED. Después de esto, la presentación será pública y cualquiera podrá acceder a ella. ¿Qué deseas hacer?",
		"i.Quiz"					: "Quiz",
		...
		"i.QuizErrorQuestionsUnsupported" : "Algunos elementos no están soportados por ViSH Editor y no pudieron ser convertidos.",
		"i.QuizLaunch"				: "Lanzar",
		...
		"i.QuizScore"				: "Puntuación",
		"i.QuizSessionName"			: "Nombre del Cuestionario en Vivo",
		"i.QuizSettings"			: "Ajustes de Quiz",
		"i.QuizSettingsToolbar"		: "Ajustes de Quiz",
		"i.QuizStop"				: "Detener",
		"i.QuizSubmittedAlert" 		: "Tu respuesta ha sido enviada",
		"i.Quizzes"					: "Quizzes (Cuestionarios)",
		"i.QuizzesWriteOptions"		: "Escribe aquí las opciones",
		"i.QuizzesWriteOptionsOpen"	: "Escribe aquí la respuesta",
		"i.QuizzesWriteOptionsSorting"	: "Escribe aquí el primer elemento de la secuencia",
		"i.readJSONfileError"		: "Error al leer el fichero JSON",
		"i.recommendationsTitle"	: "Presentaciones recomendadas:",
		"i.Religion"				: "Religión",
		"i.Remove"					: "Borrar",
		"i.Resize+"					: "Escalar+",
		"i.Resize-"					: "Escalar-",
		...
		"i.Response"				: "Respuesta",
		"i.ResponseCorrect"			: "Respuesta correcta",
		"i.Rotate"					: "Rotar",
		"i.save"					: "guardar",
		"i.Save"					: "Guardar",
		...
		"i.Settings"				: "Ajustes",
		"i.SettingsToolbar"			: "Ajustes",
		"i.ShuffleChoices"			: "Barajar opciones",
		"i.Slide"					: "Diapositiva",
		...
		"i.Themes"					: "Temas",
		"i.thumbnails"				: "galería",
		"i.Time"					: "Tiempo",
		"i.Title"					: "Título",
		"i.TitleM"					: "Título *",
		"i.toJSON"					: "a JSON",
		"i.toSCORM12"				: "a SCORM 1.2",
		"i.toSCORM2004"				: "a SCORM 2004",
		...
		"i.Unpublishing"			: "Retirando",
		"i.Unpublish_confirmation"	: "Vas a retirar la publicación de esta presentación de la plataforma ViSH-UNED. Después de esto la presentación será privada y solo tú podras acceder a ella. ¿Qué deseas hacer?",
		"i.Unknown"					: "Desconocido",
		"i.Unlimited"				: "Ilimitado",
		...
		"i.upload"					: "subir",
		"i.Upload"					: "Subir",
		"i.uploadErrorWrongServer"	: "El servidor a respondido con un error",
		"i.uploadErrorTooBig"		: "El archivo supera los 8MB pruebe a intentarlo de nuevo",
		"i.uploadErrorCantReach"	: "La petición no puede llegar al servidor",
		"i.uploadHasToSaveFirst"	: "Debe guardar primero la presentación antes de poder subir un archivo adjunto.",
		"i.url"						: "enlace",
		"i.Url"						: "Enlace",
		"i.Version"					: "Versión",
		"i.Vertical"				: "Vertical",
		...
		"i.wappSettings"			: "Ajustes de la Aplicación Web",
		"i.wappSettingsEnableAPI"	: "Activar API de Aplicación Web",
		"i.wappSettingsSecores"		: "Esta aplicación envía puntuaciones",
		"i.yes"						: "si",
		"i.Yes"						: "Si",
		...
		"i.tooltip.UploadAttachment" : "Si no puedes subir un archivo adjunto, guarda primero la presentación",
		//Video Tutorials
